...
/* Every course/block registered here. Add a new block's data file, then add
   ...
   glossary) is generic. */
const BLOCKS_BY_ID = { A: BLOCK_A, B: BLOCK_B, F1: FPS_BLOCK1, F2: FPS_BLOCK2, F3: FPS_BLOCK3, F4: FPS_BLOCK4, F5: FPS_BLOCK5, F6: FPS_BLOCK6, F7: FPS_BLOCK7, F8: FPS_BLOCK8 };
const COURSES = [
