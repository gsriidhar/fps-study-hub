...
```mermaid
flowchart TD
  S0["Customers / counterparties"]
  S1["Payment systems: Bacs, Faster Payments, CHAPS, SWIFT, SEPA, ACH"]
  S0 --> S1
  S2["Company bank accounts (multiple banks / currencies)"]
  S1 --> S2
  S3["Treasury / cash management team"]
  S2 --> S3
  S4["Payments operations team fixes exceptions"]
  S3 --> S4
```
