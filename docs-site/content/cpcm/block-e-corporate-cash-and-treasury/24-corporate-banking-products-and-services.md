---
title: "Corporate Banking Products & Services"
lesson_number: 24
...
```mermaid
flowchart TD
  S0["Buyer's bank issues a Letter of Credit guaranteeing payment"]
  S1["Seller ships the goods and presents the agreed documents to their own bank"]
  S0 --> S1
  S2["Documents verified as compliant"]
  S1 --> S2
  S3["Payment released to the seller via the two banks"]
  S2 --> S3
```
