---
title: "Career Pathways, Exam Strategy & Course Wrap-Up"
lesson_number: 40
...
```mermaid
flowchart TD
  S0["Payments Analyst / Payments Operations Analyst"]
  S1["Treasury Analyst/Manager — cash, liquidity, FX/interest rate risk"]
  S0 --> S1
  S2["Transaction Banking — corporate client relationship and product roles"]
  S1 --> S2
  S3["Compliance/Financial Crime Analyst — AML, sanctions, fraud"]
  S2 --> S3
  S4["Product/Innovation roles — Open Banking, embedded finance, fintech"]
  S3 --> S4
```
